  ...
  const features = [
    {
      ...
      description: 'Watch algorithms come alive with smooth, step-by-step animations',
    ...
    <div className="flex flex-col w-full max-w-7xl mx-auto px-4 py-12 lg:py-20">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-500/10 backdrop-blur-sm mb-4">
          ...
          <span className="text-xs font-mono text-cyan-400 tracking-wider uppercase">Our Mission</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-light">
          AlgoScope transforms abstract code into dynamic, step-by-step animations, 
          empowering the next generation of developers to master logic through motion.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="text-xl space-y-6 text-slate-300 leading-relaxed font-light">
            <p>
              AlgoScope was born from a simple observation: <span className="text-white font-medium italic underline decoration-cyan-500/50 underline-offset-4">Logic is easier to understand when you can see it.</span> 
            </p>
            <p>
              In a world of static textbooks and dry documentation, we wanted to build a tool that felt alive.
              By merging cutting-edge web technologies with academic rigor, we&apos;ve created a sandbox where
              complexity becomes clarity.
            </p>            <div className="pt-4 grid grid-cols-2 md:grid-cols-3 gap-6 border-t border-white/5">
              <div>
                <p className="text-2xl font-bold text-white">10+</p>
                <p className="text-sm text-slate-500 uppercase tracking-widest">Algorithms</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-white">4</p>
                <p className="text-sm text-slate-500 uppercase tracking-widest">Languages</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-white">100%</p>
                <p className="text-sm text-slate-500 uppercase tracking-widest">Interactive</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <h3 className="text-3xl font-bold text-white mb-4 leading-tight">Empowering Visual Learning</h3>
          <p className="text-indigo-100/70 text-lg font-light leading-relaxed">
            We believe that understanding the &quot;how&quot; and &quot;why&quot; is more important than memorizing syntax. 
            AlgoScope is our contribution to making computer science more accessible to everyone.
          </p>
        </motion.div>
        ...
        <div className="lg:col-span-12 mt-8">
           <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-4xl font-bold text-white tracking-tight">Core Features</h2>
          </div>
        ...
        <div className="lg:col-span-12 mt-12 pb-20">
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-4xl font-bold text-white tracking-tight">The Architects</h2>
            </div>
          </div>
